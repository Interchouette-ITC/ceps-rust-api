...
| `CEPS_WASM_ROOT`             | Contract `.wasm` dir (default in-tree `tests/wasm/`; refresh with `make fetch-wasm`) |
...
| `make fetch-wasm`                    | Refresh tip CEP contracts into committed `tests/wasm/`             |
